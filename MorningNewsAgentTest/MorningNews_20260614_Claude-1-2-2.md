...
```mermaid
xychart-beta
  title "Brent Crude (USD/bbl) — May to June 2026"
  x-axis ["8 May", "15 May", "22 May", "29 May", "5 Jun", "12 Jun"]
  y-axis "USD/bbl" 80 --> 115
  line [109.75, 104.20, 98.50, 95.10, 91.50, 87.33]
```
...
```mermaid
xychart-beta
  title "Strait of Hormuz Daily Transit Calls — Feb to Jun 2026 (% of pre-crisis)"
  x-axis ["28 Feb", "15 Mar", "8 Apr", "15 Apr", "29 May", "7 Jun"]
  y-axis "% of pre-crisis (~94/day)" 0 --> 100
  line [90, 15, 35, 30, 5, 2]
```
