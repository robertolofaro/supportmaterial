...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — Feb to Jun 2026"
    x-axis ["28 Feb", "15 Mar", "8 Apr", "22 Apr", "8 May", "22 May", "5 Jun", "8 Jun"]
    y-axis "USD/bbl" 60 --> 130
    line [72, 112, 92, 117, 105, 94, 94, 96]
```

```mermaid
xychart-beta
    title "Strait of Hormuz Transit (% of pre-crisis baseline)"
    x-axis ["1 Mar", "8 Apr ceasefire", "22 Apr", "1 May", "15 May", "31 May"]
    y-axis "% of normal" 0 --> 100
    line [3, 12, 10, 14, 12, 11]
```
