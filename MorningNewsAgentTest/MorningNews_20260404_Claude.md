...
```mermaid
xychart-beta
    title "Brent Crude Oil — Spot Price, Selected Dates (USD/bbl)"
    x-axis ["27 Feb", "9 Mar", "19 Mar", "1 Apr", "2 Apr"]
    y-axis "Price (USD/bbl)" 60 --> 120
    line [71, 94, 97, 105, 113]
```

```mermaid
xychart-beta
    title "Eurozone HICP Inflation — Monthly (%, 2026)"
    x-axis ["Jan", "Feb", "Mar"]
    y-axis "Inflation %" 1 --> 3
    line [2.1, 1.9, 2.5]
```
...
| Run timestamp       | 2026-04-04T08:00:00+02:00                     | 
