...
alert_counts:
  ...
  green: 4
ongoing_situations:
  - {name: "Russia-Ukraine war", day: 89}
  - {name: "Israel-Lebanon war", day: 89}
...
```mermaid
xychart-beta
    title "Brent Crude Oil — Daily Closes, May 2026 (USD/bbl)"
    x-axis [1 May, 5 May, 8 May, 12 May, 15 May, 19 May, 22 May, 26 May, 29 May]
    y-axis "USD/bbl" 80 --> 120
    line [116.10, 112.50, 108.20, 104.80, 101.50, 98.30, 95.10, 92.70, 92.26]
```
...
```mermaid
xychart-beta
    title "Euro Area HICP Inflation by Component — April 2026 (% YoY)"
    x-axis [All-items, Energy, Services, Food, NEIG]
    y-axis "% YoY" 0 --> 12
    bar [3.0, 10.9, 3.0, 2.5, 0.8]
```
