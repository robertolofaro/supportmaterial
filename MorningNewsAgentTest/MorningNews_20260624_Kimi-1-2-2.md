...
```mermaid
xychart-beta
    title "Brent Crude Oil Price (USD/bbl) — Hormuz Crisis Period"
    x-axis [3 Jun, 4 Jun, 5 Jun, 8 Jun, 9 Jun, 10 Jun, 11 Jun, 12 Jun, 15 Jun, 16 Jun, 17 Jun, 18 Jun, 22 Jun, 23 Jun, 24 Jun]
    y-axis "USD/bbl" 70 --> 100
    bar [96.07, 95.03, 93.09, 94.25, 91.45, 93.10, 90.38, 87.33, 83.17, 78.96, 79.55, 79.85, 77.90, 77.08, 76.51]
```
...
```mermaid
xychart-beta
    title "Strait of Hormuz Daily Transit Volume — Post-MOU Recovery"
    x-axis [17 Jun, 18 Jun, 19 Jun, 20 Jun, 21 Jun, 22 Jun]
    y-axis "Million Barrels" 0 --> 20
    bar [3.8, 8.5, 12.0, 14.5, 16.0, 15.2]
```
