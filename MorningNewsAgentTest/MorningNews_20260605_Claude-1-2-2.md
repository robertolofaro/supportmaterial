...
```mermaid
xychart-beta
    title "Brent Crude USD/bbl — Recent Sessions (Jun 2026)"
    x-axis ["1 Jun", "2 Jun", "3 Jun", "4 Jun", "5 Jun (est)"]
    y-axis "USD/bbl" 88 --> 108
    line [96.42, 96.65, 101.36, 96.70, 96.70]
```
...
```mermaid
xychart-beta
    title "Hormuz Transit Volume — % of Pre-Crisis Normal (Mar–May 2026)"
    x-axis ["Mar 4", "Mar 19", "Apr 8", "Apr 13 (blockade)", "May (avg)", "May 31"]
