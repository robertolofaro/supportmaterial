...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — 8 June 2026 Intraday Trajectory"
    x-axis ["Open", "Pre-spike", "Spike peak", "Post-Iran pause", "Close (8 Jun)"]
    y-axis "USD/bbl" 88 --> 100
    line [93.09, 93.50, 97.22, 95.02, 94.48]
```

```mermaid
xychart-beta
    title "Strait of Hormuz — Daily Transit Vessels (% of pre-crisis normal, March–June 2026)"
    x-axis ["Early Mar", "Mid Mar", "Early Apr", "Ceasefire (8 Apr)", "Late Apr", "Mid May", "31 May"]
    y-axis "% of pre-crisis normal" 0 --> 100
    line [5, 8, 10, 22, 18, 12, 11]
```
