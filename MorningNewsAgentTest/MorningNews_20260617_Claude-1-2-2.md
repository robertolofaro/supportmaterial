...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — June 2026 Decline on Iran Deal Optimism"
    x-axis ["9 Jun", "10 Jun", "11 Jun", "12 Jun", "13 Jun", "16 Jun", "17 Jun"]
    y-axis "USD/bbl" 75 --> 100
    line [95.06, 94.40, 92.00, 89.50, 87.00, 83.80, 82.94]
```

```mermaid
xychart-beta
    title "Eurozone HICP Inflation YoY (%) — Feb–May 2026"
    x-axis ["Feb 2026", "Mar 2026", "Apr 2026", "May 2026"]
    y-axis "%" 1.5 --> 3.5
    line [1.9, 2.6, 3.0, 3.2]
```
