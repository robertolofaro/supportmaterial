...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — June 2026 sessions"
    x-axis ["1 Jun", "2 Jun", "3 Jun", "4 Jun", "5 Jun", "8 Jun", "9 Jun", "10 Jun"]
    y-axis "USD/bbl" 88 --> 100
    line [94.00, 94.00, 98.80, 96.00, 94.66, 91.10, 91.10, 96.10]
```
...
```mermaid
xychart-beta
    title "Strait of Hormuz transit — % of pre-crisis baseline (94 vessels/day)"
    x-axis ["28 Feb", "1 Mar", "Apr avg", "1 May", "6 May", "11 May", "3 Jun", "7 Jun"]
    y-axis "% of baseline" 0 --> 100
    line [100, 60, 20, 8, 2, 2, 2, 2]
```
