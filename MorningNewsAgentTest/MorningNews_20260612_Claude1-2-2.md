...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — Conflict Phase, March–June 2026"
    x-axis ["1 Mar", "15 Mar", "1 Apr", "15 Apr", "1 May", "15 May", "1 Jun", "11 Jun"]
    y-axis "USD/bbl" 60 --> 130
    line [82, 98, 105, 112, 108, 103, 96, 94]
```
...
```mermaid
xychart-beta
    title "Strait of Hormuz Daily Transit Volume — Apr to Jun 2026 (% of pre-crisis)"
    x-axis ["14 Apr", "1 May", "6 May", "15 May", "1 Jun", "3 Jun", "7 Jun"]
    y-axis "% of pre-crisis (94/day baseline)" 0 --> 25
    line [5, 8, 14, 10, 4, 3, 2]
```
