...
xychart-beta
    ...
    x-axis ["28 Feb", "19 Mar", "7 Apr (peak)", "17 Apr", "28 May", "5 Jun", "9 Jun"]
    y-axis "USD/bbl" 65 --> 145
    line [72, 98, 138, 108, 94, 95, 91]
```
...
```mermaid
xychart-beta
    title "Hormuz Transit Volume — % of Pre-War Baseline (Feb–Jun 2026)"
    x-axis ["28 Feb", "2 Mar", "7 Apr", "17 Apr", "1 May", "5 Jun", "9 Jun"]
    y-axis "% of pre-war" 0 --> 105
    line [100, 3, 6, 12, 5, 5, 5]
```
