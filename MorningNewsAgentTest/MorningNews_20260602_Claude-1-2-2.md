...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — Iran War Period (Feb–Jun 2026)"
    x-axis ["28 Feb", "12 Mar", "7 Apr", "15 Apr", "28 Apr", "15 May", "29 May", "2 Jun"]
    y-axis "USD/bbl" 60 --> 145
    line [68, 115, 138, 105, 108, 102, 91, 95]
```

```mermaid
xychart-beta
    title "EU HICP Annual Inflation (%) — Nov 2025–Apr 2026"
    x-axis ["Nov 25", "Dec 25", "Jan 26", "Feb 26", "Mar 26", "Apr 26"]
    y-axis "% YoY" 1 --> 4
    bar [2.1, 2.0, 1.7, 1.9, 2.6, 3.0]
```
