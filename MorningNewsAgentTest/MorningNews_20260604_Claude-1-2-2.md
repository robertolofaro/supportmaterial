...
```mermaid
xychart-beta
    title "Brent Crude (USD/bbl) — June 2026 Escalation Window"
    x-axis ["28 May", "29 May", "1 Jun", "2 Jun", "3 Jun"]
    y-axis "USD/bbl" 90 --> 105
    line [96.40, 96.65, 96.42, 96.65, 97.81]
```

```mermaid
xychart-beta
    title "Strait of Hormuz Transit Volume (% of pre-crisis baseline)"
    x-axis ["Week 1 (Mar)", "Week 4 (Mar)", "Week 5 (Apr)", "Week 8 (May)", "31 May"]
    y-axis "% of Normal (baseline ~95/day)" 0 --> 20
    line [6, 7, 6, 9, 11]
```
